...
const Products = ({ categories, filtered, products, setProducts, search }) => {
  ...
  return (
    <div className="products-wrapper grid grid-cols-card gap-4">
      ...
      bg-purple-800 flex justify-center items-center hover:opacity-90 min-h-[180px]"
      ...
      <div
        className="product-item border hover:shadow-lg cursor-pointer transition-all select-none
      bg-orange-800 flex justify-center items-center hover:opacity-90 min-h-[180px]"
